...
export const Canvas = ({
    ...
    const insertLayer = useMutation((
        ...
        layerType: LayerType.Ellipse | LayerType.Rectangle | LayerType.Rectangle | LayerType.Text | LayerType.Note,
        position: Point,
    ) => {
    ...
    const onPoinerLeave = useMutation((
        { setMyPresence  }
    ) => {
    ...
    return (
        <main
         className="h-screen relative bg-neutral-100 touch-none"
        >
